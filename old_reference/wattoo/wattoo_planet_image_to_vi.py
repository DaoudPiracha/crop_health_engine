...
if __name__ == '__main__':
    ...
    z_score_ts_file = f'/Users/daoud/PycharmProjects/DISA/ai4h_disa/experimental/wattoo_cire_z_scores_ts.csv'
    ...
    z_score_file_n = glob.glob(f'/Users/daoud/PycharmProjects/DISA/ai4h_disa/experimental/wattoo/wattoo_cire_z_scores_norm.csv')
    z_score_df_n = []
